...
export default function PublicUserProfile() {
  ...
  const handlerFollow = async () => {
    await dispatch(userFollowAction(userId));
    await dispatch(getPublicProfileAction(userId));
  };

  //Unfollow
  const handlerUnFollow = async () => {
    await dispatch(userUnFollowAction(userId));
    await dispatch(getPublicProfileAction(userId));
  };
  ...
  const handlerBlock = async () => {
    console.log("Block");
    await dispatch(userBlockAction(userId));
    await dispatch(getPublicProfileAction(userId));
  };
  ...
  const handlerUnBlock = async () => {
    console.log("Unblock");
    await dispatch(userUnBlockAction(userId));
    await dispatch(getPublicProfileAction(userId));
  };
            ...
            <article>
              ...
              <div>
                ...
                <div className="mx-auto max-w-8xl px-4 sm:px-6 lg:px-8">
                  <div className="-mt-12 ml-55 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                    ...
                    <div className="flex flex-col mt-6 space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4">
                      ...
                      >
                        ...
                        Block {profile?.userdata?.blockedUsers?.length}
                      </button>
