...
export default function PostStats({
  ...
  const handlerLikes = () => {
    dispatch(likesPostAction(postID));
  };

  const dislikeHandler = () => {
    dispatch(disLikesPostAction(postID));
  };

  const clapsHandler = () => {
    dispatch(clapsPostAction(postID));
  };
  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-2 p-2 md:justify-start">
      ...
      <button
        className="flex items-center gap-1 m-2 text-2xl text-gray-400"
        onClick={clapsHandler}
      >
        <PiHandsClappingFill className="text-2xl" />
        {claps}
      </button>
